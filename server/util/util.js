...
function encrypt(str){
    ...
    let obj=crypto.createHash('sha256'); // Changed from 'md5' to 'sha256'
    obj.update(str+salt);
...
function encodeJwt(){
    ...
    let secretOrPrivateKey=process.env.JWT_SECRET || "default_secret_key"; // Use environment variable for secret key
